...
class UserHelper(context : Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    companion object{
        ...
        private val SQL_CREATE_ENTRIES =
            " CREATE TABLE ${UserContract.UserEntry.TABLE_NAME} (" +
                    ...
                    "${UserContract.UserEntry.COLUMN_PASS} VARCHAR(255))"
    ...
    fun insertData(user: User){
        ...
        val sql = "INSERT INTO ${UserContract.UserEntry.TABLE_NAME} " +
                ...
                " ${UserContract.UserEntry.COLUMN_PASS} ) " +
    ...
    fun getData(email: String, password: String) : User? {
        ...
        val sql = " SELECT * FROM ${UserContract.UserEntry.TABLE_NAME} WHERE ${UserContract.UserEntry.COLUMN_EMAIL} = '${email}' AND ${UserContract.UserEntry.COLUMN_PASS} = '${password}'"
        ...
        if(cursor.moveToFirst()){
            ...
            val password  = cursor.getString(cursor.getColumnIndexOrThrow(UserContract.UserEntry.COLUMN_PASS))
